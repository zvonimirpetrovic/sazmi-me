...
capitals = "([A-Ž])"
lowercase = "([a-ž])"
prefixes = "(g|gosp|gđa|gđica|dr|mag|sc)[.]"
suffixes = "(d|)[.]"
starters = "(Gosp|Gđa|Gđica|Dr|On|Ona|Ono|Oni|One|Ona|Mi|Vi|Ali|Nego|Već|Iako|Tako|Ovo|Štogod|Koliko|Kao|Kako|Danas|Jučer|Tada)"
acronyms = "([A-Ž][.][A-Ž][.](?:[A-Ž][.])?)"
months = "[.](siječnja|siječanj|veljače|veljača|ožujka|ožujak|travnja|travanj|svibnja|svibanj|lipnja|lipanj|srpnja|srpanj|kolovoza|kolovoz|rujna|rujan|listopada|listopad|studenog|studeni|prosinca|prosinac)"
digits = "([0-9])"
dates = "([0-9])[.]"
...
class SummaryTool(object):
    ...
    def split_content_to_sentences(self, content):
        ...
        if "Ph.D" in content: content = content.replace("Ph.D.","Ph<prd>D<prd>")
